...
class Server:
    ...
    def fetch_action_space(self) -> int:
        ...
        Uses the 'ASP' command as per the protocol.
    ...
    def send_action(self, action) -> None:
        ...
        Uses the 'ACT <action>' command as per the protocol.
    ...
    def fetch_results(self) -> typing.Tuple[int, float, bool, bool, dict]:
        """
        Fetches the action result from the client. Client sends all the data line by line but in one string.
        Each line has some flag followed by values. The last line contains only END flag.
        Flags are OBS, REW, TER, TRN, INF
